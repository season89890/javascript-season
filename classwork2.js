...
//5. Write a function that filters and displays products that cost more than 100
const filterMore100 = () => cart.filter((product) => product.price > 100);
console.log(filterMore100 ());
...
// function mEProduct () {
//     const expensive = cart.reduce((prev, curr) => curr.price > prev.price ? curr : prev);
